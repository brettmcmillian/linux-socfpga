...
static char const stat_gstrings[][ETH_GSTRING_LEN] = {
	"txstat_frames_lessthan_64B_w_crcerr",
	"txstat_oversized_frames_w_crcerr",
	"txstat_frames_w_crcerr",
	"txstat_frames_w_crcerr_on_ok",
	"txstat_multicast_data_frames_w_crcerr",
	"txstat_broadcast_data_frames_w_crcerr",
	"txstat_unicast_data_frames_w_crcerr",
	"txstat_multicast_control_frames_w_crcerr",
	"txstat_broadcast_control_frames_w_crcerr",
	"txstat_unicast_control_frames_w_crcerr",
	"txstat_pause_frame_w_crcerr",
	"txstat_64B_frames",
	"txstat_65B_127B_frames",
	"txstat_128B_255B_frames",
	"txstat_256B_511B_frames",
	"txstat_512B_1023B_frames",
	"txstat_1024B_1518B_frames",
	"txstat_1519B_max_frames",
	"txstat_oversize_frames",
	"txstat_multicast_data_frames_wo_err",
	"txstat_broadcast_data_frames_wo_err",
	"txstat_unicast_data_frames_wo_err",
	"txstat_multicast_control_frames_wo_err",
	"txstat_broadcast_control_frames_wo_err",
	"txstat_unicast_control_frames_wo_err",
	"txstat_pause_frame_wo_err",
    "txstat_frames_lessthan_64B_and_crcerr",
	"txstat_num_frame_starts",
	"txstat_num_length_errors",
	"txstat_pfc_frames_w_crcerr",
	"txstat_pfc_frames_wo_err",
	"txstat_payload_wo_err",
	"txstat_frame_bytes_wo_err",
	"txstat_malformed_frames",
	"txstat_packets_dropped_w_err",
	"txstat_frames_w_bad_length_type",
	"rxstat_frames_lessthan_64B_w_crcerr",
	"rxstat_oversized_frames_w_crcerr",
	"rxstat_frames_w_crcerr",
	"rxstat_frames_w_crcerr_on_ok",
	"rxstat_multicast_data_frames_w_crcerr",
	"rxstat_broadcast_data_frames_w_crcerr",
	"rxstat_unicast_data_frames_w_crcerr",
	"rxstat_multicast_control_frames_w_crcerr",
	"rxstat_broadcast_control_frames_w_crcerr",
	"rxstat_unicast_control_frames_w_crcerr",
	"rxstat_pause_frame_w_crcerr",
	"rxstat_64B_frames",
	"rxstat_65B_127B_frames",
	"rxstat_128B_255B_frames",
	"rxstat_256B_511B_frames",
	"rxstat_512B_1023B_frames",
	"rxstat_1024B_1518B_frames",
	"rxstat_1519B_max_frames",
	"rxstat_oversize_frames",
	"rxstat_multicast_data_frames_wo_err",
	"rxstat_broadcast_data_frames_wo_err",
	"rxstat_unicast_data_frames_wo_err",
	"rxstat_multicast_control_frames_wo_err",
	"rxstat_broadcast_control_frames_wo_err",
	"rxstat_unicast_control_frames_wo_err",
	"rxstat_pause_frame_wo_err",
	"rxstat_frames_lessthan_64B_and_crcerr",
	"rxstat_num_frame_starts",
	"rxstat_num_length_errors",
	"rxstat_pfc_frames_w_crcerr",
	"rxstat_pfc_frames_wo_err",
	"rxstat_payload_wo_err",
	"rxstat_frame_bytes_wo_err",
	"rxstat_malformed_frames",
	"rxstat_packets_dropped_w_err",
	"rxstat_frames_w_bad_length_type",
};
