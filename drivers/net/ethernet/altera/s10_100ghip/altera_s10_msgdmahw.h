...
#ifndef __ALTERA_S10_MSGDMAHW_H__
#define __ALTERA_S10_MSGDMAHW_H__
...
#define MSGDMA_DESC_CTL_WAIT_WRESP	BIT(25)
...
/* mSGDMA CSR Component Configuration 1 */
#define MSGDMA_CSR_COMP_CFG1_BURST_ENABLE		BIT(0)
#define MSGDMA_CSR_COMP_CFG1_BURST_WRAPPPING	BIT(1)
#define MSGDMA_CSR_COMP_CFG1_CHANNEL_ENABLE		BIT(2)
#define MSGDMA_CSR_COMP_CFG1_CHANNEL_WIDTH(x)	(((x) >> 3) & 0x7)
#define MSGDMA_CSR_COMP_CFG1_DATA_FIFO_DEPTH(x)	(((x) >> 6) & 0xf)
#define MSGDMA_CSR_COMP_CFG1_DATA_WIDTH(x)		(((x) >> 10) & 0x7)
#define MSGDMA_CSR_COMP_CFG1_DESC_FIFO_DEPTH(x)	(((x) >> 13) & 0x7)
#define MSGDMA_CSR_COMP_CFG1_DMA_MODE(x)		(((x) >> 16) & 0x3)
#define MSGDMA_CSR_COMP_CFG1_ENHANCED_FEAT		BIT(18)
#define MSGDMA_CSR_COMP_CFG1_ERROR_ENABLE		BIT(19)
#define MSGDMA_CSR_COMP_CFG1_ERROR_WIDTH(x)		(((x) >> 20) & 0x7)
#define MSGDMA_CSR_COMP_CFG1_MAX_BURST_COUNT(x)	(((x) >> 23) & 0xf)
#define MSGDMA_CSR_COMP_CFG1_MAX_BYTE(x)		(((x) >> 27) & 0x1f)

/* mSGDMA CSR Component Configuration 2 */
#define MSGDMA_CSR_COMP_CFG2_STRIDE_ENABLE		BIT(0)
#define MSGDMA_CSR_COMP_CFG2_MAX_STRIDE(x)		(((x) >> 1) & 0x00007fff)
#define MSGDMA_CSR_COMP_CFG2_PACKET_ENABLE		BIT(16)
#define MSGDMA_CSR_COMP_CFG2_PREFETCHER_ENABLE	BIT(17)
#define MSGDMA_CSR_COMP_CFG2_PROG_BURST_ENABLE	BIT(18)
#define MSGDMA_CSR_COMP_CFG2_RESPONSE_PORT(x)	(((x) >> 19) & 0x3)
#define MSGDMA_CSR_COMP_CFG2_TRANSFER_TYPE(x)	(((x) >> 21) & 0x3)
