...
/* This header file describes the CSR Slave for the tx_dispatcher component */

#ifndef __TX_DISPATCHER_CSR_REGS_H__
#define __TX_DISPATCHER_CSR_REGS_H__
...
/* Byte Addresses */
#define TX_DISPATCHER_CSR_BUSY_REG (0x0)
#define TX_DISPATCHER_CSR_START_REG (0x8)
#define TX_DISPATCHER_CSR_INTERRUPT_ENABLE_REG (0x10)
#define TX_DISPATCHER_CSR_INTERRUPT_STATUS_REG (0x18)
#define TX_DISPATCHER_CSR_RETURNDATA_REG (0x20)
#define TX_DISPATCHER_CSR_ARG_ADDR32_REG (0x28)
#define TX_DISPATCHER_CSR_ARG_ADDR64_REG (0x30)
...
#define TX_DISPATCHER_CSR_BUSY_MASK   (1<<0)
#define TX_DISPATCHER_CSR_BUSY_OFFSET (0)

#define TX_DISPATCHER_CSR_START_MASK   (1<<0)
#define TX_DISPATCHER_CSR_START_OFFSET (0)

#define TX_DISPATCHER_CSR_INTERRUPT_ENABLE_MASK   (1<<0)
#define TX_DISPATCHER_CSR_INTERRUPT_ENABLE_OFFSET (0)

#define TX_DISPATCHER_CSR_INTERRUPT_STATUS_MASK   (1<<0)
#define TX_DISPATCHER_CSR_INTERRUPT_STATUS_OFFSET (0)
#define TX_DISPATCHER_CSR_DONE_MASK   (1<<1)
#define TX_DISPATCHER_CSR_DONE_OFFSET (1)


#endif /* __TX_DISPATCHER_CSR_REGS_H__ */
